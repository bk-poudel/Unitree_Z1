...
class Z1Sim:
    ...
    def solve_ik(self, target_position, target_orientation=None, initial_q=None, max_iter=100, eps=1e-4):
        """
        ...
        ee_frame_id = self.pin_model.getFrameId("endeffector_link")
        ...
        for i in range(max_iter):
            ...
            # Compute Jacobian
            J = pin.computeFrameJacobian(self.pin_model, self.pin_data, q, ee_frame_id, pin.ReferenceFrame.LOCAL_WORLD_ALIGNED)[:3, :] # Position only
...
if __name__ == "__main__":
    ...
    ee_frame_id = sim.pin_model.getFrameId("endeffector_link")
    ...
    target_position = current_ee_pos.copy()
    target_position[0] += 0.1  # Add 10cm in X direction
