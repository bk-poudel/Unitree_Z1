...
bottle_reach_pos = np.array([0.25, 0.0, 0.4])
# Position to grasp the bottle
bottle_grasp_pos = np.array([0.25, 0.0, 0.18])
# Position just above the wine glass
glass_reach_pos = np.array([0.25, 0.4, 0.3])
# Position to release the bottle
glass_release_pos = np.array([0.25, 0.4, 0.18])
