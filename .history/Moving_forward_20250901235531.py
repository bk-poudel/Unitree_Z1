...
for target in trajectory:
    ...
    orientation_error = target_orientation @ current_ee_pose[:3, :3].T
    orientation_error = orientation_error.rotvec()
    ...
    J = current_ee_pose[:3, :3] @ J[:3, :]  # Rotate Jacobian to world frame
    J = J[:3, :]
    ee_vel = J @ dq
