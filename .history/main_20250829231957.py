...
def main():
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        print(
            "Robot end effector moving 10 cm in x direction with PD control. Orientation is kept unchanged. Press ESC to exit."
        )
        for x in x_path:
            ...
            inverse_kinematics_with_orientation(
                model, temp_data, ee_body_id, target, initial_quat
            )
